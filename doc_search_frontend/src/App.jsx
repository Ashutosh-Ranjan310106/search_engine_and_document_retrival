...
import { listDocuments, deleteDocument, getStats } from "./api.js";
...
export default function App() {
  ...
  const [sidebarTab,            setSidebarTab]          = useState("docs"); // "docs" | "search"
  ...
  const handleCitationClick = (citation) => {
    // Find doc in list (may be partial object from citation)
    const doc = docs.find((d) => d.doc_id === citation.doc_id);
    if (doc) {
      setSelectedDoc(doc);
      // Small delay so viewer mounts with correct doc first
